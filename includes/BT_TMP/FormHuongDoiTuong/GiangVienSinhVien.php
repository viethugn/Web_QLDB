...
<?php 
	...
	class GiangVien extends Nguoi{
		...
		function TinhLuong(){
			switch($this->trinhDo){
				case "cunhan" :
					return 2.34*self::Luong;break;
				case "thacsi" :
					return 3.67*self::Luong; break;
				case "tiensi" :
					return 5.66*self::Luong; break;
			}
		}
...
<fieldset>
	...
	<table border='0'>
		...
		<tr><td>Họ tên:</td><td><input type="text"  name="hoTen" value="<?php if(isset($_POST['hoTen'])) echo $_POST['hoTen'];?>"/></td></tr>
        <tr><td>Địa chỉ:</td><td><input type="text"  name="diaChi" value="<?php if(isset($_POST['diaChi'])) echo $_POST['diaChi'];?>"/></td></tr>
		<tr><td>Giới tính:</td><td><input type="radio" name="gioiTinh" value="Nam"<?php if(isset($_POST['gioiTinh'])&&$_POST['gioiTinh']=='Nam') echo 'checked="checked"';?> checked/>		Nam
		<input type="radio" name="gioiTinh" value="Nu" <?php if(isset($_POST['gioiTinh'])&&$_POST['gioiTinh']=='Nu') echo 'checked="checked"';?>/>
			N&#7919; </td></tr>

        <tr><td>Đối tượng:</td><td><input type="radio" name="nghe" value="GV"<?php if(isset($_POST['nghe'])&&$_POST['nghe']=='GV') echo 'checked="checked"';?> checked/>Giảng Viên
	...
	<fieldset >
		...
		<tr><td>Kết quả:</td>
			...
			<td><textarea name="ketqua" cols="40" rows="10" disabled="disabled"><?php echo $str;?></textarea></td></tr>
