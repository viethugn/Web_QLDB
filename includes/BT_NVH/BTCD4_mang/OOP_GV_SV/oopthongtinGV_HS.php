	...
	<table border='0'>
		<tr>
            ...
            <td>
                ...
                <?php if(isset($_POST['nguoi'])&&($_POST['nguoi'])=="gv") echo 'checked="checked"'?> required/>Giáo Viên
                <input type="radio" name="nguoi" value="sv"
                onchange="this.form.submit();"
                <?php if(isset($_POST['nguoi'])&&($_POST['nguoi'])=="sv") echo 'checked="checked"'?> required/>Sinh Viên
            </td>
        </tr>
		<tr>
            <td>Nhập họ tên:</td>
        ...
        <tr>
            <td>
                <fieldset style="width: 200px;" onchange="this.form.submit();" <?php echo $disabledname1; ?>>
                    ...
                    <input type="text" disabled  name="luongcbgv" 
                    value="<?php echo $luongcbgv; ?>"/>
            ...
            <td>
                <fieldset style="width: 200px;" onchange="this.form.submit();" <?php echo $disabledname2; ?>>
                    ...
                    <input type="text" disabled  name="luongcbsv" 
                    
                    value="<?php echo $luongcbsv; ?>"/>
